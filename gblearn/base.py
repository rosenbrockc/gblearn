...
def set_testmode(testing):
    ...
    testmode = testing
nprocs = None
"""int: number of processors to use for parallel jobs.
"""
def set_nprocs(nprocs_):
    """Sets the number of processors for parallel batch jobs.
    
    Args:
        nprocs_ (int): number of processors.
    """
    global nprocs
    nprocs = nprocs_
